...
$(function() {
    ...
    var citiesByCountry = {
        sa: ['مكة المكرمة', 'الرياض', 'جدة', 'المدينة المنورة', 'الاحساء', 'الدمام', 'الطائف', 'بريدة', 'تبوك', 'القطيف', 'خميس مشيط', 'الخبر', 'حفر الباطن', 'الجبيل', 'الخرج', 'أبها', 'حائل', 'نجران'],
        eg: ['القاهرة', 'الجِيزَة', 'الاسكندريه', 'شبرا الخيمه', 'بور سعيد', 'السويس', 'المحلة الكبرى', 'الأقصر', 'أسيوط'],
        jo: ['عمان', 'الزرقاء'],
        sy: ['دمشق', 'حلب', 'حماه']
    };
